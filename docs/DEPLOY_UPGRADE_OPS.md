...
MindUser 是一个 Node.js + Fastify + MySQL 的会员系统，服务分区包括：
...
```bash
mysql -h 127.0.0.1 -P 3306 -u <user> -p minduser < /home/xx/backup/minduser_xxx.sql
